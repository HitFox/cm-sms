...
RSpec.describe 'deliver sms' do  
  ...
  before do
    ...
    stub_request(:post, "http://test.host/example").
      with(
        body: "<?xml version=\"1.0\" encoding=\"UTF-8\"?><MESSAGES><AUTHENTICATION><PRODUCTTOKEN>SOMETOKEN</PRODUCTTOKEN></AUTHENTICATION><MSG><FROM>Sender</FROM><TO>+41 44 111 22 33</TO><DCS>0</DCS><BODY>lorem ipsum</BODY><REFERENCE>Ref:123</REFERENCE></MSG></MESSAGES>", 
